...
def find_files(suffix, path):
    ...
    for dirs in os.listdir(path):
        ...
        if os.path.isdir(pathalogic):
            os.chdir(pathalogic)            # adds specified list elements to the end of the current list if not done the final 'return paths' yields an empty list
...
print("\nYo Passed :)" if (check_paths(relative_paths, slash)) else "Oops, Failed :(")
...
print("Yo Passed :)" if (check_paths(relative_paths, slash)) else "Oops, Failed :(")
