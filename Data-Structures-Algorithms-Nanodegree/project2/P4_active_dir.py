...
print("Expecting True - ", is_user_in_group(sub_child_user, parent))

print("Expecting False - ", is_user_in_group(sub_child_user, None))

print("Expecting False - ", is_user_in_group("", parent))

print("Expecting False - ", is_user_in_group("Galahad", "Kingsman"))
